...
SELECT DateFromParts(year(dateadd(month, -1, getdate())), month(dateadd(month, -1, getdate())), day(dateadd(month, -1, getdate())))
...
SELECT FORMAT (DATEADD(MONTH, -5, GETDATE()), 'yyyy-MM-dd') as date
--VERDADEIRO
