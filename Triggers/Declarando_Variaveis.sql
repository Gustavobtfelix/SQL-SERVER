...
--VERIFICA SE E MEIO OU FIM DE SEMANA
...
IF @DIA_SEMANA = 'Domingo' OR @DIA_SEMANA = 'Sábado'
   PRINT 'Este dia Efim de semana'
ELSE
   PRINT 'Este dia Edia da semana'
...
BEGIN
   PRINT 'Valor estourou. Nao e possivel abrir novos creditos'
END
ELSE
BEGIN
   PRINT 'Valor nao estourou. e possiel abrir novos creditos'
END
