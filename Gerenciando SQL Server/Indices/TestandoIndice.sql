...
-- Diferenca e que nao foi colcoado mais n como PRIMARY KEY.
-- Criar nums duas vezes. Executar a consulta com e sem indice
-- Verificar no TRACE.
--cria função com 10 milhões de numeros
USE SUCOS_VENDAS;
